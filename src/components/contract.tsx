  ...
  return (
    <div id="contract-preview" className="prose prose-slate max-w-none p-8 md:p-12">
      ...
      <Clause title="CLÁUSULA SEGUNDA – DO OBJETO">
        <p>2.1 pelo presente instrumento, A CONTRATADA formaliza a venda da licença do PROGRAMA em favor do CONTRATANTE, bem como demais componentes do produto.</p>
        <p><strong>Parágrafo único:</strong> As partes acordam que a relação comercial de compra e venda se restringe somente entre o A CONTRATADA e o CONTRATANTE, isentando a HIPER de qualquer responsabilidade consumerista, bem como de prestação de serviço de suporte a CONTRATANTE.</p>
        <p>2.1.2. O presente Contrato tem por objeto a licença para utilização software conforme Proposta comercial enviada ao CONTRATANTE com preços condições de pagamento detalhamento do produto contratado e implantação que faz parte do presente termo de uso. Em caso de contradição entre a proposta comercial e o presente contrato prevalece as disposições da proposta comercial.</p>
        <p>2.1.3 A CONTRATADA não garante que o Sistema HIPER atenderão todas as necessidades e especificidades demandadas pelo (a) CONTRATANTE; a ausência de determinada qualificação no HIPER não obrigará a CONTRATADA e/ou HIPER a customizá-los.</p>
        <p>2.1.4 O HIPER poderá vir a ter novas versões, resultantes de modificações em suas atuais características, por razões técnicas de compatibilização com a evolução de seus recursos e plataformas de geração e operação, e principalmente, objetivando as suas próprias evoluções</p>
        <p>2.1.5 O HIPER será fornecido por meio eletrônico, sem mídias, para garantir que o (a) CONTRATANTE tenham sempre as competentes versões mais atualizadas.</p>
        <p>2.1.6 Não estão incluídos no presente contrato o fornecimento de softwares e a prestação de serviços que não estejam especificados neste Instrumento ou proposta comercial; porém poderão ser detalhados em proposição comercial separada, que poderá ser objeto de aditivo contratual ou contratação própria, autônoma e específica.</p>
      </Clause>

      <Clause title="CLÁUSULA TERCEIRA – DAS OBRIGAÇÕES E RESPONSABILIDADES">
        <p>3.1. A CONTRATADA garante o perfeito funcionamento do HIPER ERP, em condições normais de funcionamento e sob o cumprimento das orientações especificações técnicas de utilização, excetuando-se assim problemas causados por falha nos equipamentos ou má utilização, ou problemas causados por ausência de atualizações de versões e/ou erros relacionados às plataformas eletrônicas do (a) CONTRATANTE.</p>
        <p>3.1.2 A CONTRATADA JUNTO A HIPER garante a CONTRATANTE um Uptime mensal de 99,00 % para a aplicação HIPER, disponibilizando o acompanhamento e a consulta através do link que deverá ser fornecido ao CONTRATANTE.</p>
        <p>3.1.3 A CONTRATADA não intermedia, não edita, não audita, não fiscaliza e não monitora o uso do HIPER ERP pelo (a) CONTRATANTE salvo para fins técnicos e estatísticos, sem divulgação ou registro da identidade dos usuários e de dados do (a) CONTRATANTE.</p>
        <p>3.2. A CONTRATADA não se responsabiliza por danos decorrentes de mau uso ou inabilidade do (a) CONTRATANTE em relação ao HIPER ERP.</p>
        <p>3.3. A CONTRATADA não se responsabiliza pela integração desautorizada do HIPER ERP com outros softwares e/ou com o ambiente computacional do (a) CONTRATANTE que possam gerar ineficiência ou distorções de dados.</p>
        <p>3.4. O (A) CONTRATANTE e responsáveis pela manutenção, alimentação dos dados (cadastramento), preservação e back-up do HIPER ERP.</p>
        <p>3.5. A CONTRATADA não é responsável pela configuração de equipamentos e funcionalidades operacionais que sejam vinculados, direta e indiretamente, às funcionalidades do HIPER ERP, tais como mikrotik, access points, servidores de proxy, servidores de DNS, servidores web, servidores FTP etc.</p>
        <p>A CONTRATANTE Poderá solicitar serviços extras a CONTRATADA que não seja objeto deste contrato podendo ou não ser formalizado um novo contrato de serviços de manutenção em computadores e redes interna.</p>
        <p>3.6. Para fins deste Contrato, as Partes reconhecem que o HIPER ERP WEB são seguros, todavia, assim como ocorre em quaisquer ambientes virtuais, estão sujeitos a ameaças e violação criminosa, sendo estas causas excludentes da responsabilidade da CONTRATADA.</p>
        <p>3.7. As tecnologias web são suportadas por serviços de comunicação, tais como, internet e rede de telecomunicações, não oferecidos pela CONTRATADA e que podem impactar no funcionamento do HIPER ERP, sendo fato excludente da responsabilidade da CONTRATADA pelo funcionamento do HIPER ERP.</p>
      ...
      <Clause title="CLÁUSULA QUARTA – SUPORTE E CUSTOMIZAÇÃO">
        ...
        <p>4.3. O Suporte será prestado pela CONTRATADA por meio de profissionais habilitados, de forma online, para manter a agilidade e baixo custo ao (à) CONTRATANTE.</p>
        <p>4.4. A CONTRATANTE Autoriza para os devidos fins a CONTRATADA realizar remotamente operações dentro de seus computadores para melhor utilização do software. O cliente está totalmente ciente sobre o funcionamento desta operação, reconhecendo que o mesmo não representa qualquer perigo à integridade de seus equipamentos e/ou softwares, assim como reconhece a competência técnica e idoneidade da e de seus colaboradores para efetuar tal procedimento.</p>
        <p>4.5. O Treinamento poderá ser feito presencial pela CONTRATADA desde que conste na proposta comercial conforme item 1.1.9 deste contrato.</p>
        <p>4.6. Em caso de necessidade de Suporte além do padrão, este deverá ser solicitado pelo (a) CONTRATANTE, que deverá aprovar o preço adicional para consecução dos competentes serviços</p>
        <p>4.7. Os serviços de Customização poderão ser contratados, mediante o pagamento de preço adicional, pelos mesmos meios de comunicação do serviço de Suporte, podendo, porém, a CONTRATADA, a seu exclusivo critério, exigir a formalização da prestação de serviço em instrumento jurídico apropriado.</p>
      </Clause>

      <Clause title="CLÁUSULA QUINTA – CONDIÇÕES COMERCIAIS">
        <p>5.1. A aceitação deste Contrato dar-se-á mediante adesão eletrônica, por meio da rede mundial de computadores, sendo enviado por e-mail para a CONTRATANTE.</p>
        <p>5.2 pelo licenciamento e utilização do HIPER ERP (a) CONTRATANTE pagará a CONTRATADA o valor dividido conforme consta na proposta comercial apresenta a CONTRATANTE com seus respectivos módulos.</p>
        <p>5.3. O valor inicialmente contratado poderá ser alterado em razão de eventual renovação do licenciamento e utilização do HIPER ERP ou novas liberações de módulos não constates na proposta inicial apresentada.</p>
        <p>5.4. O presente instrumento contratual vigorará pelo prazo mínimo de 6 (seis meses) meses, podendo ser rescindido pela CONTRATADA caso a CONTRATANTE não repasse os valores conforme estabelecido na cláusula 5.2 deste contrato.</p>
        <p>5.5. Transcorrido o período da contratação entabulado, caso não haja expressa manifestação em sentido contrário da CONTRATANTE, a ser exercida na forma escrita ou da própria CONTRATADA, enviará as competentes notas fiscais ao(à) CONTRATANTE depois de perfectibilizada a quitação dos preços; serão enviadas para e-mail cadastrado pelo(a) CONTRATANTE, tão somente na sua versão eletrônica (NFS-e).</p>
        <p>5.9. Concorda o (a) CONTRATANTE que as contratações/aquisições de licenças, plugins e quaisquer outros serviços (inclusive de terceiros), necessários para o devido funcionamento do HIPER ERP, não abrange à presente contratação; de modo que deverão ser arcados pelo (a) próprio (a) CONTRATANTE, sem qualquer direito à reembolso.</p>
        <p>5.10. O inadimplemento de quaisquer valores devidos em razão deste Contrato, na data estipulada, ensejará a aplicação de multa na ordem de 2% (dois por cento) sobre o valor da parcela inadimplida, bem como de juros de moratório de 1% (um por cento) ao mês, calculados “pro rata die”, e correção monetária pela variação positiva do IGPM/FGV.</p>
        <p>5.11 A falta de pagamento de duas parcelas, consecutivas ou aleatórias, acarretará na rescisão do presente contrato e o imediato bloqueio de acesso e funcionamento do PROGRAMA caso não tenha backup poderá haver pedada de arquivos, bem ainda a cobrança de eventual valor inadimplido de forma administrativa ou judicial, independente de prévia comunicação judicial ou extrajudicial.</p>
        <p>5.12. O inadimplemento dos valores devidos à CONTRATADA autoriza o registro do nome do (a) CONTRATANTE e de eventuais devedores solidários nos cadastros de inadimplência, bem como o pronto protesto dos competentes títulos e a cobrança extrajudicial e/ou judicial do crédito.</p>
      </Clause>

      <Clause title="CLÁUSULA SEXTA – PROPRIEDADE INTELECTUAL">
        <p>6.1. A CONTRATADA Não é proprietária e detentora dos direitos autorais sobre o código-fonte do HIPER ERP, além das demais tecnologias desenvolvidas no âmbito deste Contrato, sendo todos protegidos e regulados pela Lei 9.609/98 a empresa desenvolvedora em comum acordo com a CONTRATADA.</p>
      </Clause>
      ...
      <Clause title="CLÁUSULA OITAVA – DA RESCISÃO">
        <p>8.1 O presente instrumento contratual vigorará pelo prazo mínimo de 6 (seis meses) , podendo ser rescindido pela CONTRATADA caso a CONTRATANTE não repasse os valores conforme estabelecido na proposta comercial apresentada.</p>
