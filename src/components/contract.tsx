  ...
  return (
    <div id="contract-preview" className="prose prose-slate max-w-none p-8 md:p-12">
      ...
      <Clause title="CLÁUSULA SEGUNDA – DO OBJETO">
        ...
        <p style={textStyle}><strong>Parágrafo único:</strong> As partes acordam que a relação comercial de compra e venda se restringe somente entre o A CONTRATADA e o CONTRATANTE, isentando a HIPER de qualquer responsabilidade consumerista, bem como de prestação de serviço de suporte a CONTRATANTE.</p>
        <p style={textStyle}>2.1.2. O presente Contrato tem por objeto a licença para utilização software conforme Proposta comercial enviada ao CONTRATANTE com preços condições de pagamento detalhamento do produto contratado e implantação que faz parte do presente termo de uso. Em caso de contradição entre a proposta comercial e o presente contrato prevalece as disposições da proposta comercial.</p>
        <p style={textStyle}>2.1.3 A CONTRATADA não garante que o Sistema HIPER atenderão todas as necessidades e especificidades demandadas pelo (a) CONTRATANTE; a ausência de determinada qualificação no HIPER não obrigará a CONTRATADA e/ou HIPER a customizá-los.</p>
        <p style={textStyle}>2.1.4 O HIPER poderá vir a ter novas versões, resultantes de modificações em suas atuais características, por razões técnicas de compatibilização com a evolução de seus recursos e plataformas de geração e operação, e principalmente, objetivando as suas próprias evoluções</p>
        <p style={textStyle}>2.1.5 O HIPER será fornecido por meio eletrônico, sem mídias, para garantir que o (a) CONTRATANTE tenham sempre as competentes versões mais atualizadas.</p>
        <p style={textStyle}>2.1.6 Não estão incluídos no presente contrato o fornecimento de softwares e a prestação de serviços que não estejam especificados neste Instrumento ou proposta comercial; porém poderão ser detalhados em proposição comercial separada, que poderá ser objeto de aditivo contratual ou contratação própria, autônoma e específica.</p>
      </Clause>
      ...
      <Clause title="CLÁUSULA TERCEIRA – DAS OBRIGAÇÕES E RESPONSABILIDADES">
        ...
        <p style={textStyle}>3.1.2 A CONTRATADA JUNTO A HIPER garante a CONTRATANTE um Uptime mensal de 99,00 % para a aplicação HIPER, disponibilizando o acompanhamento e a consulta através do link que deverá ser fornecido ao CONTRATANTE.</p>
        <p style={textStyle}>3.1.3 A CONTRATADA não intermedia, não edita, não audita, não fiscaliza e não monitora o uso do HIPER ERP pelo (a) CONTRATANTE salvo para fins técnicos e estatísticos, sem divulgação ou registro da identidade dos usuários e de dados do (a) CONTRATANTE.</p>
        <p style={textStyle}>3.2. A CONTRATADA não se responsabiliza por danos decorrentes de mau uso ou inabilidade do (a) CONTRATANTE em relação ao HIPER ERP.</p>
        <p style={textStyle}>3.3. A CONTRATADA não se responsabiliza pela integração desautorizada do HIPER ERP com outros softwares e/ou com o ambiente computacional do (a) CONTRATANTE que possam gerar ineficiência ou distorções de dados.</p>
        <p style={textStyle}>3.4. O (A) CONTRATANTE e responsáveis pela manutenção, alimentação dos dados (cadastramento), preservação e back-up do HIPER ERP.</p>
        <p style={textStyle}>3.5. A CONTRATADA não é responsável pela configuração de equipamentos e funcionalidades operacionais que sejam vinculados, direta e indiretamente, às funcionalidades do HIPER ERP, tais como mikrotik, access points, servidores de proxy, servidores de DNS, servidores web, servidores FTP etc.</p>
        <p style={textStyle}>A CONTRATANTE Poderá solicitar serviços extras a CONTRATADA que não seja objeto deste contrato podendo ou não ser formalizado um novo contrato de serviços de manutenção em computadores e redes interna.</p>
        <p style={textStyle}>3.6. Para fins deste Contrato, as Partes reconhecem que o HIPER ERP WEB são seguros, todavia, assim como ocorre em quaisquer ambientes virtuais, estão sujeitos a ameaças e violação criminosa, sendo estas causas excludentes da responsabilidade da CONTRATADA.</p>
        <p style={textStyle}>3.7. As tecnologias web são suportadas por serviços de comunicação, tais como, internet e rede de telecomunicações, não oferecidos pela CONTRATADA e que podem impactar no funcionamento do HIPER ERP, sendo fato excludente da responsabilidade da CONTRATADA pelo funcionamento do HIPER ERP.</p>
        <p style={textStyle}>3.8. O (A) CONTRATANTE está ciente de que é indispensável que o terminal onde o sistema será utilizado tenha acesso à internet e navegador moderno (tais como: Google Chrome, Mozilla Firefox, Safari), devidamente atualizado, para o preciso funcionamento HIPER GESTÃO.</p>
        <p style={textStyle}>3.9. É proibido qualquer procedimento realizado pelo (a) CONTRATANTE que implique no aluguel, arrendamento, cessão, empréstimo, seja total ou parcial, do HIPER ERP a terceiros.</p>
        <p style={textStyle}>3.10. A CONTRATADA não se responsabilizará pelos resultados produzidos pelo HIPER ERP, caso estes sejam afetados por algum tipo de programa externo, como aqueles conhecidos popularmente como vírus, ou por falha de operação.</p>
        <p style={textStyle}>3.11. A CONTRATADA não se responsabilizará, ainda, por: (i) Integração do HIPER ERP com qualquer outro software de terceiros ou do (a) CONTRATANTE; (ii) operação do HIPER ERP por pessoas não autorizadas; (iii) qualquer defeito decorrente de culpa exclusiva do(a) CONTRATANTE ; e (iv) pelos danos ou prejuízos decorrentes de decisões administrativas, gerenciais ou comerciais tomadas com base nas informações fornecidas pelo HIPER ERP.</p>
        <p style={textStyle}>3.12. Respeitadas as previsões legais relativas a esta espécie de contrato, a CONTRATADA não será responsabilizada pelo uso abusivo, ou uso em desacordo com as especificações técnicas aplicáveis, ou em razão de modificações ou ajustes sistêmicos realizados (inclusive combinação, conexão, operação ou uso de qualquer componente com equipamento ou documentação não fornecido pela CONTRATADA), do HIPER ERP pelo(a) CONTRATANTE ou por qualquer terceiro não autorizado pela CONTRATADA, inclusive por lucros cessantes, perda de dados, descontinuidade de negócios, relacionados ao uso ou mau uso do HIPER ERP, mesmo nos casos em que a CONTRATADA tenha sido comunicada.</p>
        <p style={textStyle}>3.13. A CONTRATADA não será responsabilizada por quaisquer atrasos ou falha no cumprimento de suas obrigações, caso sejam resultantes de fatos alheios à vontade das partes, ou ainda em razão de fatores que fujam de seu controle sistêmico, incluindo casos fortuitos e/ou eventos de força maior.</p>
        <p style={textStyle}>3.14. Qualquer prejuízo que o(a) CONTRATANTE vierem a experimentar, pelo uso inadequado do HIPER ERP, pelo cadastramento incorreto de quaisquer dados nas plataformas da CONTRATADA ou pelas informações constantes em boletos bancários/notas fiscais que foram fornecidas pelo(a) CONTRATANTE; não serão suportados pela CONTRATADA.</p>
        <p style={textStyle}>3.15 Utilizar do SISTEMA fornecido ERP, de forma ilegal, propiciando a sonegação fiscal de impostos.</p>
      ...
      <Clause title="CLÁUSULA QUINTA – CONDIÇÕES COMERCIAIS">
        ...
        <p style={textStyle}>5.2 pelo licenciamento e utilização do HIPER ERP (a) CONTRATANTE pagará a CONTRATADA o valor dividido conforme consta na proposta comercial apresenta a CONTRATANTE com seus respectivos módulos.</p>
        <p style={textStyle}>5.3. O valor inicialmente contratado poderá ser alterado em razão de eventual renovação do licenciamento e utilização do HIPER ERP ou novas liberações de módulos não constates na proposta inicial apresentada.</p>
        <p style={textStyle}>5.4. O presente instrumento contratual vigorará pelo prazo mínimo de 6 (seis meses) meses, podendo ser rescindido pela CONTRATADA caso a CONTRATANTE não repasse os valores conforme estabelecido na cláusula 5.2 deste contrato.</p>
        <p style={textStyle}>5.5. Transcorrido o período da contratação entabulado, caso não haja expressa manifestação em sentido contrário da CONTRATANTE, a ser exercida na forma escrita ou da própria CONTRATADA, enviará as competentes notas fiscais ao(à) CONTRATANTE depois de perfectibilizada a quitação dos preços; serão enviadas para e-mail cadastrado pelo(a) CONTRATANTE, tão somente na sua versão eletrônica (NFS-e).</p>
        <p style={textStyle}>5.9. Concorda o (a) CONTRATANTE que as contratações/aquisições de licenças, plugins e quaisquer outros serviços (inclusive de terceiros), necessários para o devido funcionamento do HIPER ERP, não abrange à presente contratação; de modo que deverão ser arcados pelo (a) próprio (a) CONTRATANTE, sem qualquer direito à reembolso.</p>
        <p style={textStyle}>5.10. O inadimplemento de quaisquer valores devidos em razão deste Contrato, na data estipulada, ensejará a aplicação de multa na ordem de 2% (dois por cento) sobre o valor da parcela inadimplida, bem como de juros de moratório de 1% (um por cento) ao mês, calculados “pro rata die”, e correção monetária pela variação positiva do IGPM/FGV.</p>
        <p style={textStyle}>5.11 A falta de pagamento de duas parcelas, consecutivas ou aleatórias, acarretará na rescisão do presente contrato e o imediato bloqueio de acesso e funcionamento do PROGRAMA caso não tenha backup poderá haver pedada de arquivos, bem ainda a cobrança de eventual valor inadimplido de forma administrativa ou judicial, independente de prévia comunicação judicial ou extrajudicial.</p>
        <p style={textStyle}>5.12. O inadimplemento dos valores devidos à CONTRATADA autoriza o registro do nome do (a) CONTRATANTE e de eventuais devedores solidários nos cadastros de inadimplência, bem como o pronto protesto dos competentes títulos e a cobrança extrajudicial e/ou judicial do crédito.</p>
      </Clause>
